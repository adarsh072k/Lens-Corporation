...
export default function About() {
  return (
    <>
      ...
      <section className="h-screen py-12 hover:scale-105 transition-transform duration-300">
        <div className="container mx-auto text-center space-x-40">
          ...
          <div className="flex flex-row-reverse w-4/5 justify-between items-center  bg-customBlue p-8 lg:p-12 rounded-lg transition duration-300">
